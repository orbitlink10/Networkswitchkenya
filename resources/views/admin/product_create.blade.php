    ...
    <div class="admin-main admin-management-main">
        ...
        <section class="panel admin-product-create-panel">
            <form class="admin-product-create-form" method="post" action="{{ $isEditingProduct ? route('admin.products.update', $productToEdit) : route('admin.products.store') }}" enctype="multipart/form-data">
                    ...
                    <details class="admin-product-optional-panel">
                        ...
                        <div class="admin-product-optional-body">
                            ...
                            @if($productOfficialMediaFieldsReady)
                                ...
                                <input class="admin-product-input" id="official_image_url" type="url" name="official_image_url" value="{{ old('official_image_url', $productToEdit?->official_image_url) }}" placeholder="https://... product image URL">
                ...
                @if($productSeoFieldsReady)
                    <details class="admin-product-optional-panel">
                        <summary>Switch Specifications</summary>
                        <div class="admin-product-optional-body">
                            <div class="admin-form-grid admin-form-grid--4">
                                <div>
                                    <label class="admin-product-label" for="port_count">Total Ports</label>
                                    <input class="admin-product-input" id="port_count" type="number" name="port_count" min="0" value="{{ old('port_count', $productToEdit?->port_count) }}">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="rj45_ports">RJ45 Ports</label>
                                    <input class="admin-product-input" id="rj45_ports" type="number" name="rj45_ports" min="0" value="{{ old('rj45_ports', $productToEdit?->rj45_ports) }}">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="poe_ports">PoE Ports</label>
                                    <input class="admin-product-input" id="poe_ports" type="number" name="poe_ports" min="0" value="{{ old('poe_ports', $productToEdit?->poe_ports) }}">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="sfp_ports">SFP Ports</label>
                                    <input class="admin-product-input" id="sfp_ports" type="number" name="sfp_ports" min="0" value="{{ old('sfp_ports', $productToEdit?->sfp_ports) }}">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="sfp_plus_ports">SFP+ Ports</label>
                                    <input class="admin-product-input" id="sfp_plus_ports" type="number" name="sfp_plus_ports" min="0" value="{{ old('sfp_plus_ports', $productToEdit?->sfp_plus_ports) }}">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="sfp28_ports">SFP28 Ports</label>
                                    <input class="admin-product-input" id="sfp28_ports" type="number" name="sfp28_ports" min="0" value="{{ old('sfp28_ports', $productToEdit?->sfp28_ports) }}">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="qsfp_ports">QSFP Ports</label>
                                    <input class="admin-product-input" id="qsfp_ports" type="number" name="qsfp_ports" min="0" value="{{ old('qsfp_ports', $productToEdit?->qsfp_ports) }}">
                                </div>
                            </div>

                            <div class="admin-form-grid admin-form-grid--3">
                                <div>
                                    <label class="admin-product-label" for="poe_standard">PoE Standard</label>
                                    <select class="admin-product-input admin-product-select" id="poe_standard" name="poe_standard">
                                        <option value="">Non-PoE</option>
                                        @foreach(\App\Support\SwitchCatalog::poeStandards() as $value => $label)
                                            <option value="{{ $value }}" @selected(old('poe_standard', $productToEdit?->poe_standard) === $value)>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div>
                                    <label class="admin-product-label" for="poe_budget">PoE Budget (Watts)</label>
                                    <input class="admin-product-input" id="poe_budget" type="number" name="poe_budget" min="0" value="{{ old('poe_budget', $productToEdit?->poe_budget) }}">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="poe_max_per_port">Max PoE per Port (Watts)</label>
                                    <input class="admin-product-input" id="poe_max_per_port" type="number" name="poe_max_per_port" min="0" value="{{ old('poe_max_per_port', $productToEdit?->poe_max_per_port) }}">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="management_type">Management</label>
                                    <select class="admin-product-input admin-product-select" id="management_type" name="management_type">
                                        <option value="">Select</option>
                                        @foreach(\App\Support\SwitchCatalog::managementTypes() as $value => $label)
                                            <option value="{{ $value }}" @selected(old('management_type', $productToEdit?->management_type) === $value)>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div>
                                    <label class="admin-product-label" for="layer">Layer</label>
                                    <select class="admin-product-input admin-product-select" id="layer" name="layer">
                                        <option value="">Select</option>
                                        <option value="l2" @selected(old('layer', $productToEdit?->layer) === 'l2')>Layer 2</option>
                                        <option value="l3" @selected(old('layer', $productToEdit?->layer) === 'l3')>Layer 3</option>
                                    </select>
                                </div>
                                <div>
                                    <label class="admin-product-label" for="port_speed">Port Speed</label>
                                    <select class="admin-product-input admin-product-select" id="port_speed" name="port_speed">
                                        <option value="">Select</option>
                                        @foreach(\App\Support\SwitchCatalog::speeds() as $value => $label)
                                            <option value="{{ $value }}" @selected(old('port_speed', $productToEdit?->port_speed) === $value)>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div>
                                    <label class="admin-product-label" for="uplink_type">Uplink Type</label>
                                    <select class="admin-product-input admin-product-select" id="uplink_type" name="uplink_type">
                                        <option value="">Select</option>
                                        @foreach(\App\Support\SwitchCatalog::uplinks() as $value => $label)
                                            <option value="{{ $value }}" @selected(old('uplink_type', $productToEdit?->uplink_type) === $value)>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="admin-form-grid admin-form-grid--3">
                                <div>
                                    <label class="admin-product-label" for="switching_capacity">Switching Capacity</label>
                                    <input class="admin-product-input" id="switching_capacity" type="text" name="switching_capacity" value="{{ old('switching_capacity', $productToEdit?->switching_capacity) }}" placeholder="e.g. 48 Gbps">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="forwarding_rate">Forwarding Rate</label>
                                    <input class="admin-product-input" id="forwarding_rate" type="text" name="forwarding_rate" value="{{ old('forwarding_rate', $productToEdit?->forwarding_rate) }}" placeholder="e.g. 35.7 Mpps">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="mac_table">MAC Address Table</label>
                                    <input class="admin-product-input" id="mac_table" type="text" name="mac_table" value="{{ old('mac_table', $productToEdit?->mac_table) }}" placeholder="e.g. 8K">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="cooling">Cooling</label>
                                    <select class="admin-product-input admin-product-select" id="cooling" name="cooling">
                                        <option value="">Select</option>
                                        <option value="fanless" @selected(old('cooling', $productToEdit?->cooling) === 'fanless')>Fanless</option>
                                        <option value="active" @selected(old('cooling', $productToEdit?->cooling) === 'active')>Active (Fan)</option>
                                    </select>
                                </div>
                                <div>
                                    <label class="admin-product-label" for="power_supply">Power Supply</label>
                                    <input class="admin-product-input" id="power_supply" type="text" name="power_supply" value="{{ old('power_supply', $productToEdit?->power_supply) }}">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="power_consumption">Power Consumption</label>
                                    <input class="admin-product-input" id="power_consumption" type="text" name="power_consumption" value="{{ old('power_consumption', $productToEdit?->power_consumption) }}">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="operating_temperature">Operating Temperature</label>
                                    <input class="admin-product-input" id="operating_temperature" type="text" name="operating_temperature" value="{{ old('operating_temperature', $productToEdit?->operating_temperature) }}">
                                </div>
                                <div>
                                    <label class="admin-product-label" for="warranty">Warranty</label>
                                    <input class="admin-product-input" id="warranty" type="text" name="warranty" value="{{ old('warranty', $productToEdit?->warranty) }}" placeholder="e.g. Limited Lifetime">
                                </div>
                            </div>

                            <div class="admin-form-grid admin-form-grid--3">
                                <div>
                                    <label class="admin-product-label" for="availability">Availability</label>
                                    <select class="admin-product-input admin-product-select" id="availability" name="availability">
                                        <option value="">Derive from stock</option>
                                        <option value="in_stock" @selected(old('availability', $productToEdit?->availability) === 'in_stock')>In Stock</option>
                                        <option value="out_of_stock" @selected(old('availability', $productToEdit?->availability) === 'out_of_stock')>Out of Stock</option>
                                        <option value="preorder" @selected(old('availability', $productToEdit?->availability) === 'preorder')>Preorder</option>
                                    </select>
                                </div>
                            </div>

                            <div class="admin-form-grid admin-form-grid--checkboxes">
                                @foreach([
                                    ...
                                    'stackable' => 'Stackable',
                                ] as $boolField => $boolLabel)
                                    <label class="admin-checkbox">
                                        <input type="checkbox" name="{{ $boolField }}" value="1" @checked(old($boolField, $productToEdit?->{$boolField}))>
                                        <span>{{ $boolLabel }}</span>
                                    </label>
                                @endforeach
                            </div>
                            ...
                            <div class="admin-form-grid admin-form-grid--checkboxes">
                                <span class="admin-product-label">Applications (select all that apply)</span>
                                @foreach(\App\Support\SwitchCatalog::applications() as $appSlug => $appLabel)
                                    <label class="admin-checkbox">
                                        <input type="checkbox" name="applications[]" value="{{ $appSlug }}" @checked(in_array($appSlug, old('applications', $productToEdit?->applicationSlugs() ?? []), true))>
                                        <span>{{ $appLabel }}</span>
                                    </label>
                                @endforeach
                            </div>
                ...
                <details class="admin-product-optional-panel">
                    ...
                    <div class="admin-product-optional-body">
                        ...
                        <div class="admin-product-divider" aria-hidden="true"></div>

                        <label class="admin-product-label" for="import_url">Import from Image URL</label>
                        <input
                            class="admin-product-input"
                            id="import_url"
                            type="url"
                            name="import_url"
                            value="{{ old('import_url') }}"
                            placeholder="https://cdn.mikrotik.com/web-assets/rb_images/1539_lg.webp"
                        >
                        <p class="admin-product-optional-copy">Paste a manufacturer image URL to download, optimize and store it locally. The original URL is kept for reference. (Or use <code>php artisan images:import</code> to bulk-import.)</p>
                    </div>
                </details>
